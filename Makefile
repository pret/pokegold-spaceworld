...
ASMFILES := $(call rwildcard, $(DIRS), *.asm) $(FILES) hack/hack.asm
...
.PHONY: tidy
tidy:
	rm -rf $(ROM) $(CORRECTEDROM) $(ROMS:.gb=.sym) $(ROMS:.gb=.map) $(OBJS) $(BUILD)/shim.asm $(BUILD)/hack/relocated_text.asm $(BUILD)/hack/text/*
