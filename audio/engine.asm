...
Func_e8168: ; e8168 (3a:4168)
    or $80
    ldh [rNR14], a
    ret

Func_e816d: ; e816d (3a:416d)
    ld a, [wCurTrackDuty]
    ldh a, [rNR11]
    and $3f
    or d
