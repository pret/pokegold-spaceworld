; Map IDs
	...
	const WASTE_MART_5F
	const WASTE_MART_6F
	const WASTE_MART_ELEVATOR
	const WASTE_RADIO_TOWER_1F
	const WASTE_RADIO_TOWER_2F
	const WASTE_RADIO_TOWER_3F
	const WASTE_RADIO_TOWER_4F
	const WASTE_RADIO_TOWER_5F
	const WASTE_ROCKET_RAIDED_HOUSE
	const WASTE_POKECENTER_1F
	const WASTE_POKECENTER_2F
	const WASTE_GYM
	const WASTE_HOUSE_1
	const WASTE_HOUSE_2
