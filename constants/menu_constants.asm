...
; used by PokemonActionSubmenu (see engine/menus/start_menu.asm)
	const_def 1
	; moves
	const MONMENUITEM_UPROOT      ; 1
	const MONMENUITEM_WIND_RIDE   ; 2
	const MONMENUITEM_WATER_SPORT ; 3
	const MONMENUITEM_STRONG_ARM  ; 4
	const MONMENUITEM_BRIGHT_MOSS ; 5
...
; ScrollingMenu items structure format
	...
	const_skip 4
	shift_const SCROLLINGMENU_BALL_POCKET
