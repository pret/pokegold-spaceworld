...
; PokerMinigame Card Types
	const_def 2
	const POKERCARD_PIKACHU
	const POKERCARD_ODDISH
	const POKERCARD_JIGGLYPUFF
	const POKERCARD_POLIWAG
	const POKERCARD_PORYGON
DEF POKERCARD_TYPES EQU (const_value - 2)
DEF POKER_NUM_CARDS EQU 5
DEF POKER_MAX_CARDS EQU POKERCARD_TYPES * 10
DEF POKER_MAX_TURNS EQU 40
