...
; ITEM_WHITE_FEATHER
	item_attribute 10, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_CONFUSE_CLAW
	item_attribute 10, HELD_CONFUSE_CLAW, 15, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_WISDOM_ORB
	item_attribute 10, HELD_RAISE_SP_DEFENSE, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_STEEL_SHELL
	item_attribute 10, HELD_RAISE_DEFENSE, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_UP_GRADE
	item_attribute 10, HELD_RAISE_ALL_STATS, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_STRANGE_THREAD
...
; ITEM_STRANGE_POWER
	item_attribute 10, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_LIFE_TAG
	item_attribute 10, HELD_LIFE_TAG, 1, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_POISON_FANG
	item_attribute 10, HELD_POISON_BOOST, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_CORDYCEPS
	item_attribute 10000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; ITEM_STICK
	item_attribute 10, HELD_NORMAL_BOOST, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_FLEE_FEATHER
	item_attribute 10, HELD_FLEE_FEATHER, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_ICE_FANG
...
; ITEM_SHARP_HORN
	item_attribute 10, HELD_RAISE_ATTACK, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_LUCKY_EGG
	item_attribute 10, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_LONG_VINE
	item_attribute 10, HELD_CATCH_CHANCE, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; ITEM_ICE_WING
	item_attribute 10, HELD_RAISE_SP_DEFENSE, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_THUNDER_WING
	item_attribute 10, HELD_RAISE_SPEED, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_FIRE_WING
; should use HELD_RAISE_SP_ATTACK instead of HELD_SP_ATTACK_UP, according to the item description.
...
; ITEM_DRAGON_SCALE
	item_attribute 10, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_BERSERK_GENE
	item_attribute 10, HELD_RAISE_ALL_STATS, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_HEART_STONE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ITEM_FIRE_TAIL
