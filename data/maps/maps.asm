...
MapGroup_SilentHill:
	map Route1, TILESET_SILENT_HILL, ROUTE, LANDMARK_ROUTE_1
	map Route2, TILESET_SILENT_HILL, ROUTE, LANDMARK_ROUTE_2
	map Route23, TILESET_SILENT_HILL, ROUTE, LANDMARK_ROUTE_23
	map SilentHill, TILESET_SILENT_HILL, TOWN, LANDMARK_SILENT_HILL
	map Route1Gate1F, TILESET_GATE, GATE, LANDMARK_ROUTE_2
	map Route1Gate2F, TILESET_GATE, GATE, LANDMARK_ROUTE_2
	map Route23Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_23
	...
	map RivalHouse, TILESET_HOUSE, INDOOR, LANDMARK_SILENT_HILL
	...
	map SilentHillLabBackUnused, TILESET_LAB, INDOOR, LANDMARK_SILENT_HILL
	map QuietHills, TILESET_FOREST, CAVE, LANDMARK_NONE

MapGroup_OldCity:
	map Route3, TILESET_OLD_CITY, ROUTE, LANDMARK_ROUTE_3
	map OldCity, TILESET_OLD_CITY, TOWN, LANDMARK_OLD_CITY
	map Route3Gate1F, TILESET_GATE, GATE, LANDMARK_ROUTE_3
	map Route3Gate2F, TILESET_GATE, GATE, LANDMARK_ROUTE_3
	map Route3House, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_3
...
MapGroup_HighTech:
	map Route6, TILESET_HIGH_TECH, ROUTE, LANDMARK_HIGH_TECH_WEST_ROUTE
	map Route7, TILESET_HIGH_TECH, ROUTE, LANDMARK_HIGH_TECH_WEST_ROUTE_OCEAN
	map HighTech, TILESET_HIGH_TECH, TOWN, LANDMARK_HIGH_TECH
	map Route7Gate, TILESET_GATE, GATE, LANDMARK_HIGH_TECH_WEST_ROUTE_OCEAN
...
MapGroup_Font:
	map Route9, TILESET_FONT, ROUTE, LANDMARK_ROUTE_9
	map Route10, TILESET_FONT, ROUTE, LANDMARK_ROUTE_10
	map Route11, TILESET_FONT, ROUTE, LANDMARK_ROUTE_11
	map Route12, TILESET_FONT, ROUTE, LANDMARK_ROUTE_12
	map Route24, TILESET_FONT, ROUTE, LANDMARK_ROUTE_24
	map Route25, TILESET_FONT, ROUTE, LANDMARK_ROUTE_25
	map Font, TILESET_FONT, TOWN, LANDMARK_FONT
	map Route9Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_9
	map Route12Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_12
	map Route24Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_24
...
MapGroup_Birdon:
	map Route4, TILESET_BIRDON, ROUTE, LANDMARK_ROUTE_4
	map Route13, TILESET_BIRDON, ROUTE, LANDMARK_ROUTE_13
	map Route14, TILESET_BIRDON, ROUTE, LANDMARK_ROUTE_14
	map Birdon, TILESET_BIRDON, TOWN, LANDMARK_BIRDON
	map Route4Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_4
	map Route14Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_14
...
MapGroup_Newtype:
	...
	map Route17, TILESET_SILENT_HILL, ROUTE, LANDMARK_ROUTE_17
	...
	map Route18Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_18
...
MapGroup_Sugar:
	map Route16, TILESET_HIGH_TECH, ROUTE, LANDMARK_ROUTE_16
	map Sugar, TILESET_HIGH_TECH, TOWN, LANDMARK_SUGAR
	map Route16Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_16
...
MapGroup_Blue:
	map Route19, TILESET_NORTH, ROUTE, LANDMARK_ROUTE_19
	map Route20, TILESET_NORTH, ROUTE, LANDMARK_ROUTE_20
	map Route26, TILESET_NORTH, ROUTE, LANDMARK_ROUTE_26
	map BlueForest, TILESET_NORTH, TOWN, LANDMARK_BLUE_FOREST
	map Route19House, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_19
	map Route20Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_20
...
MapGroup_Stand:
	map Route21, TILESET_SILENT_HILL, ROUTE, LANDMARK_ROUTE_21
	map Stand, TILESET_SILENT_HILL, TOWN, LANDMARK_STAND
	map Route21Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_21
...
MapGroup_Kanto:
	map Route22, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_22
...
MapGroup_Prince:
	map Route29, TILESET_SILENT_HILL, ROUTE, LANDMARK_PRINCE
	map Prince, TILESET_SILENT_HILL, TOWN, LANDMARK_PRINCE

MapGroup_MtFuji:
	map Route30, TILESET_SILENT_HILL, ROUTE, LANDMARK_MT_FUJI
