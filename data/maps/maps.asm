...
MapGroup_HighTech:
	map Route6, TILESET_HIGH_TECH, ROUTE, LANDMARK_ROUTE_6
	map Route7, TILESET_HIGH_TECH, ROUTE, LANDMARK_ROUTE_7
	map HighTech, TILESET_HIGH_TECH, TOWN, LANDMARK_HIGH_TECH
	map Route7Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_7
