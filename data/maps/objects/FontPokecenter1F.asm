...
SECTION "data/maps/objects/FontPokecenter1F.asm", ROMX
	...
	map_attributes FontPokecenter1F, FONT_POKECENTER_1F, 0

FontPokecenter1F_MapEvents::
	dw $4000 ; unknown

	def_warp_events
	warp_event  5,  7, FONT, 4, 59
	warp_event  6,  7, FONT, 4, 60
	warp_event  0,  7, FONT_POKECENTER_2F, 1, 57
...
FontPokecenter1F_Blocks::
INCBIN "maps/FontPokecenter1F.blk"
