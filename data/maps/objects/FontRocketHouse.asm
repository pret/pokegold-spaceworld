...
SECTION "data/maps/objects/FontRocketHouse.asm", ROMX
	...
	map_attributes FontRocketHouse, FONT_ROCKET_HOUSE, 0

FontRocketHouse_MapEvents::
	dw $4000 ; unknown

	def_warp_events
	warp_event 12,  7, FONT, 1, 63
	warp_event 13,  7, FONT, 1, 63
...
FontRocketHouse_Blocks::
INCBIN "maps/FontRocketHouse.blk"
