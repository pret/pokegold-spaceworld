...
HighTechLeague1F_MapEvents::
	...
	def_warp_events
	warp_event  3, 15, HIGHTECH, 2, 82
	warp_event  4, 15, HIGHTECH, 3, 83
	warp_event  7,  1, HIGHTECH_LEAGUE_2F, 1, 14
...
HighTechLeague1F_Blocks::
INCBIN "maps/HighTechLeague1F.blk"
