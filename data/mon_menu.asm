...
Unreferenced_FieldMoveList:
	db MOVE_UPROOT, MONMENUITEM_UPROOT
	db MOVE_WIND_RIDE, MONMENUITEM_WIND_RIDE
	db MOVE_WATER_SPORT, MONMENUITEM_WATER_SPORT
	db MOVE_STRONG_ARM, MONMENUITEM_STRONG_ARM
	db MOVE_BRIGHT_MOSS, MONMENUITEM_BRIGHT_MOSS
...
MonMenuOptions:
	db MONMENU_FIELD_MOVE, MONMENUITEM_UPROOT,      MOVE_UPROOT
	db MONMENU_FIELD_MOVE, MONMENUITEM_WIND_RIDE,   MOVE_WIND_RIDE
	db MONMENU_FIELD_MOVE, MONMENUITEM_WATER_SPORT, MOVE_WATER_SPORT
	db MONMENU_FIELD_MOVE, MONMENUITEM_STRONG_ARM,  MOVE_STRONG_ARM
	db MONMENU_FIELD_MOVE, MONMENUITEM_BRIGHT_MOSS, MOVE_BRIGHT_MOSS
