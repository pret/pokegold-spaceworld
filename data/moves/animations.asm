...
; entries correspond to constants/move_constants.asm
	...
	dw BattleAnim_Stalker
	dw BattleAnim_Attract
	dw BattleAnim_SleepTalk
	dw BattleAnim_BellChime
...
; $100
	...
	dw BattleAnim_ShakeHorizontalUnused
	dw BattleAnim_PlayerStatDown
	dw BattleAnim_BlinkEnemyMon
	dw BattleAnim_ShakeHorizontalUnused2
...
; Unused. Originally used in Generation I, and used once again in the final game, but not here for some reason.
...
; Another leftover from Generation I.
...
BattleAnim_EggBomb:
	...
	anim_wait 96
	anim_incobj 1
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $4, $6
...
BattleAnim_Softboiled:
	...
	anim_wait 16
	anim_bgeffect BATTLE_BG_EFFECT_FADE_MON_TO_LIGHT_REPEATING, $0, BG_EFFECT_USER, $40
	anim_sound 0, 0, SFX_GAME_FREAK_LOGO_RG
.loop
...
BattleAnim_ConfuseRay:
	anim_1gfx BATTLE_ANIM_GFX_SPEED
	anim_bgeffect BATTLE_BG_EFFECT_CYCLE_OBPALS, $0, $2, $0
	anim_bgeffect BATTLE_BG_EFFECT_CYCLE_BGPALS_INVERTED, $0, $2, $0
...
BattleAnim_StringShot:
	...
	anim_bgeffect BATTLE_BG_EFFECT_CYCLE_MID_OBPALS, $0, $2, $0
...
BattleAnim_DoubleEdge:
	anim_1gfx BATTLE_ANIM_GFX_HIT
	anim_call BattleAnim_TargetObj_1Row
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $2, $20
	anim_bgeffect BATTLE_BG_EFFECT_TACKLE, $0, BG_EFFECT_USER, $0
	anim_wait 3
	anim_sound 0, 1, SFX_TACKLE
...
BattleAnim_LovelyKiss:
	...
	anim_bgeffect BATTLE_BG_EFFECT_CYCLE_MID_OBPALS, $0, $2, $0
	anim_obj BATTLE_ANIM_OBJ_LOVELY_KISS, 144, 40, $0
	anim_wait 32
	anim_sound 0, 1, SFX_LICK
...
BattleAnim_Swift:
	...
	anim_sound 6, 2, SFX_GAME_FREAK_LOGO_RG
...
BattleAnim_Guillotine:
	anim_1gfx BATTLE_ANIM_GFX_CUT
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $4, $20
	anim_bgeffect BATTLE_BG_EFFECT_SHAKE_SCREEN_X, $40, $2, $0
	anim_sound 0, 1, SFX_VICEGRIP
...
BattleAnim_Flash:
	anim_1gfx BATTLE_ANIM_GFX_SPEED
	anim_sound 0, 1, SFX_GAME_FREAK_LOGO_RG
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $2, $40
	anim_wait 4
...
BattleAnim_Glare:
	anim_1gfx BATTLE_ANIM_GFX_BEAM
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $4, $40
	anim_bgeffect BATTLE_BG_EFFECT_CYCLE_OBPALS, $0, $2, $0
	anim_call BattleAnimSub_EyeBeams
	anim_wait 16
	anim_ret
...
BattleAnim_Conversion:
	...
	anim_obj BATTLE_ANIM_OBJ_CONVERSION, 132, 44, $0
	anim_obj BATTLE_ANIM_OBJ_CONVERSION, 132, 44, $8
	anim_obj BATTLE_ANIM_OBJ_CONVERSION, 132, 44, $10
	anim_obj BATTLE_ANIM_OBJ_CONVERSION, 132, 44, $18
	anim_obj BATTLE_ANIM_OBJ_CONVERSION, 132, 44, $20
	anim_obj BATTLE_ANIM_OBJ_CONVERSION, 132, 44, $28
	anim_obj BATTLE_ANIM_OBJ_CONVERSION, 132, 44, $30
	anim_obj BATTLE_ANIM_OBJ_CONVERSION, 132, 44, $38
	anim_wait 128
	anim_wait 48
	anim_ret
...
BattleAnim_Barrier:
	...
	anim_obj BATTLE_ANIM_OBJ_SCREEN, 72, 80, $0
	anim_wait 32
; This whole section was cut from the final game.
...
BattleAnim_MindReader:
	anim_1gfx BATTLE_ANIM_GFX_MISC
.loop
	anim_sound 0, 1, SFX_SWITCH_POKEMON
...
BattleAnim_NailDown:
	...
	anim_obj BATTLE_ANIM_OBJ_NAIL_DOWN, 68, 72, $0
	anim_wait 32
	anim_incobj 1
	anim_wait 12
	anim_sound 0, 0, SFX_COMET_PUNCH
...
.loop
	anim_if_param_and $1, .obj1
	anim_obj BATTLE_ANIM_OBJ_COIN_HURL, 64, 92, $4
	anim_wait 16
	anim_obj BATTLE_ANIM_OBJ_HIT, 132, 58, $4
	anim_jump .okay

.obj1
	anim_obj BATTLE_ANIM_OBJ_COIN_HURL, 64, 80, $4
	anim_wait 16
	anim_obj BATTLE_ANIM_OBJ_HIT, 132, 46, $4
.okay
	anim_wait 6
	anim_jumpuntil .loop
	anim_ret
...
BattleAnim_Reversal:
	...
	anim_bgeffect BATTLE_BG_EFFECT_CYCLE_MID_OBPALS, $0, $0, $0
	anim_sound 0, 1, SFX_MEGA_PUNCH
...
BattleAnim_SweetKiss:
	anim_2gfx BATTLE_ANIM_GFX_OBJECTS, BATTLE_ANIM_GFX_ANGELS
	anim_bgeffect BATTLE_BG_EFFECT_CYCLE_MID_OBPALS, $0, $2, $0
	anim_obj BATTLE_ANIM_OBJ_SWEET_KISS, 104, 40, $0
	anim_wait 32
	anim_sound 0, 1, SFX_LICK
...
BattleAnim_Synchronize:
	...
	anim_bgeffect BATTLE_BG_EFFECT_NIGHT_SHADE, $0, BG_EFFECT_USER, $8
.loop
	anim_wait 8
...
.loop
	anim_sound 6, 3, SFX_MENU
	anim_obj BATTLE_ANIM_OBJ_SANDSTORM, 64, 88, $63
	anim_wait 2
	anim_sound 6, 3, SFX_MENU
	anim_obj BATTLE_ANIM_OBJ_SANDSTORM, 64, 80, $64
	anim_wait 2
	anim_sound 6, 3, SFX_MENU
	anim_obj BATTLE_ANIM_OBJ_SANDSTORM, 64, 96, $63
	anim_wait 2
	anim_loop 3, .loop
.loop2
	anim_sound 0, 1, SFX_MENU
...
BattleAnim_Stalker:
	...
	anim_obp0 $e0
	anim_sound 0, 1, SFX_BUBBLEBEAM
	anim_obj BATTLE_ANIM_OBJ_STALKER, 148, 32, $0
	anim_wait 5
	anim_obj BATTLE_ANIM_OBJ_STALKER, 116, 64, $0
	anim_wait 5
	anim_obj BATTLE_ANIM_OBJ_STALKER, 148, 64, $0
	anim_wait 5
	anim_obj BATTLE_ANIM_OBJ_STALKER, 116, 32, $0
	anim_wait 5
	anim_obj BATTLE_ANIM_OBJ_STALKER, 132, 48, $0
	anim_wait 128
	anim_ret
...
BattleAnim_BellChime:
	anim_2gfx BATTLE_ANIM_GFX_MISC, BATTLE_ANIM_GFX_NOISE
	anim_obj BATTLE_ANIM_OBJ_BELL_CHIME, 72, 56, $0
	anim_wait 32
.loop
	anim_sound 0, 0, SFX_READ_TEXT
	anim_obj BATTLE_ANIM_OBJ_BELL_CHIME_NOTE, 72, 52, $0
	anim_wait 8
	anim_sound 0, 0, SFX_READ_TEXT
	anim_obj BATTLE_ANIM_OBJ_BELL_CHIME_NOTE, 72, 52, $1
	anim_wait 8
	anim_sound 0, 0, SFX_READ_TEXT
	anim_obj BATTLE_ANIM_OBJ_BELL_CHIME_NOTE, 72, 52, $2
	anim_wait 8
	anim_sound 0, 0, SFX_READ_TEXT
	anim_obj BATTLE_ANIM_OBJ_BELL_CHIME_NOTE, 72, 52, $0
	anim_wait 8
...
BattleAnim_Present:
	...
	anim_wait 48
	anim_incobj 2
	anim_if_param_equal $1, .heal
	anim_incobj 1
	anim_wait 1
	anim_1gfx BATTLE_ANIM_GFX_EXPLOSION
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $4, $24
	anim_call BattleAnimSub_Explosion2
	anim_wait 16
	anim_ret
...
.heal
	anim_wait 1
	anim_call BattleAnim_UserObj_1Row
	anim_bgeffect BATTLE_BG_EFFECT_FADE_MON_TO_LIGHT_REPEATING, $0, BG_EFFECT_TARGET, $40
	anim_sound 0, 1, SFX_GAME_FREAK_LOGO_RG
.loop2
...
BattleAnim_PainSplit:
	anim_2gfx BATTLE_ANIM_GFX_HIT, BATTLE_ANIM_GFX_OBJECTS
	anim_bgeffect BATTLE_BG_EFFECT_CYCLE_MID_OBPALS, $0, $1, $0
	anim_call BattleAnim_TargetObj_1Row
	anim_bgeffect BATTLE_BG_EFFECT_TACKLE, $0, BG_EFFECT_USER, $0
	anim_wait 4
	anim_sound 0, 1, SFX_TACKLE
	...
	anim_obj BATTLE_ANIM_OBJ_ENCORE_STAR, 112, 32, $34
	anim_obj BATTLE_ANIM_OBJ_ENCORE_STAR, 76, 80, $2c
	anim_wait 8
	anim_call BattleAnim_ShowMon_0
	anim_ret
...
BattleAnim_BatonPass:
	...
	anim_call BattleAnim_ReturnMon
	anim_wait 64
	anim_ret
...
BattleAnim_Tempt:
	anim_1gfx BATTLE_ANIM_GFX_OBJECTS
	anim_sound 0, 0, SFX_SWITCH_POKEMON
	anim_obj BATTLE_ANIM_OBJ_CAKE_TEMPT, 64, 88, $6c
	anim_wait 56
	anim_ret
...
BattleAnim_VitalThrow:
	...
	anim_wait 16
	anim_sound 0, 0, SFX_MENU
	anim_obj BATTLE_ANIM_OBJ_HIT, 64, 88, $0
	anim_wait 8
	anim_sound 0, 0, SFX_MENU
	anim_obj BATTLE_ANIM_OBJ_HIT, 56, 80, $0
	anim_wait 8
	anim_sound 0, 0, SFX_MENU
...
BattleAnim_CrossCutter:
	anim_1gfx BATTLE_ANIM_GFX_CUT
	anim_sound 0, 1, SFX_CUT
	anim_obj BATTLE_ANIM_OBJ_CROSS_CUTTER1, 152, 40, $0
	anim_obj BATTLE_ANIM_OBJ_CROSS_CUTTER2, 120, 72, $0
	anim_wait 8
...
BattleAnimSub_Drain:
	anim_sound 6, 3, SFX_WATER_GUN
	anim_obj BATTLE_ANIM_OBJ_DRAIN, $84, $2c, $0
	anim_obj BATTLE_ANIM_OBJ_DRAIN, $84, $2c, $8
	anim_obj BATTLE_ANIM_OBJ_DRAIN, $84, $2c, $10
	anim_obj BATTLE_ANIM_OBJ_DRAIN, $84, $2c, $18
	anim_obj BATTLE_ANIM_OBJ_DRAIN, $84, $2c, $20
	anim_obj BATTLE_ANIM_OBJ_DRAIN, $84, $2c, $28
	anim_obj BATTLE_ANIM_OBJ_DRAIN, $84, $2c, $30
	anim_obj BATTLE_ANIM_OBJ_DRAIN, $84, $2c, $38
	anim_ret
