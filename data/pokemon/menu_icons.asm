...
MonMenuIcons::
	...
	db ICON_LOKON      ; a4 FLAAFFY
	db ICON_RHYDON     ; a5 AMPHAROS
	...
	db ICON_JIGGLYPUFF ; ae IGGLYBUFF
	db ICON_RHYDON     ; af MIZUUO
	db ICON_PIDGEY     ; b0 NATU
	db ICON_PIDGEY     ; b1 XATU
	...
	db ICON_POLIWAG    ; c7 POLITOED
	db ICON_RHYDON     ; c8 SLOWKING
	db ICON_UNOWN      ; c9 UNOWN
	db ICON_MUSHI      ; ca LEDYBA
	db ICON_MUSHI      ; cb MITSUBOSHI
	db ICON_TAUROS     ; cc PUCHICORN
	db ICON_LOKON      ; cd ESPEON
	db ICON_LOKON      ; ce UMBREON
	...
	db ICON_MRMIME     ; dc MAGBY
	db ICON_ODDISH     ; dd BELLOSSOM
	...
	db ICON_ONIX       ; f1 STEELIX
	db ICON_LAPRAS     ; f2 KINGDRA
	db ICON_LOKON      ; f3 RAI
	db ICON_LOKON      ; f4 EN
	db ICON_LOKON      ; f5 SUI
	db ICON_LOKON      ; f6 SNEASEL
	db ICON_PIDGEY     ; f7 HO_OH
	db ICON_CLEFAIRY   ; f8 TOGEPI
