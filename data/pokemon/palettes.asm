PokemonPalettes::
	...
	db PAL_BROWNMON  ; NATU
	db PAL_BROWNMON  ; XATU
	db PAL_REDMON    ; GYOPIN
	db PAL_PINKMON   ; MARILL
	db PAL_CYANMON   ; MANBO1
	db PAL_CYANMON   ; IKARI
	db PAL_BLUEMON   ; GROTESQUE
	db PAL_PURPLEMON ; X_ING
	db PAL_REDMON    ; PARA
	...
	db PAL_PINKMON   ; HAPPY
	db PAL_GREENMON  ; SCISSORS
	db PAL_BROWNMON  ; PLUCKS
	db PAL_REDMON    ; DEVIL
