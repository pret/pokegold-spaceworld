...
SpriteAnimGFX:
	...
	sprite_anim_obj_gfx 128, BANK(TitleFireGFX),     .DeletedGFX    ; SPRITE_ANIM_DICT_TITLE_FLAME_NOTE
	sprite_anim_obj_gfx  16, $37,                    .DeletedGFX    ; SPRITE_ANIM_DICT_MINIGAME_PICROSS
	sprite_anim_obj_gfx  16, BANK(PokedexCursorGFX), .DeletedGFX    ; SPRITE_ANIM_DICT_TEXT_CURSOR
	sprite_anim_obj_gfx  16, BANK(GameFreakLogoGFX), .DeletedGFX    ; SPRITE_ANIM_DICT_GS_SPLASH
	sprite_anim_obj_gfx  16, BANK(SlotMachine2GFX),  .DeletedGFX    ; SPRITE_ANIM_DICT_SLOTS
	sprite_anim_obj_gfx  16, BANK(PointerGFX),       .DeletedGFX    ; SPRITE_ANIM_DICT_ARROW_CURSOR
