...
if DEF(_GOLD)
	...
	db  9, DEX_LEDYBA, ITEM_NONE, MOVE_SCRATCH, MOVE_QUICK_ATTACK, MOVE_NONE, MOVE_NONE
	db -1 ; end
endc
if DEF(_SILVER)
...
; Unused Green(?) data
	db 50, DEX_REMORAID, DEX_LIP, DEX_BELLOSSOM, DEX_BULBASAUR, DEX_CHARMANDER, DEX_SQUIRTLE, 0
...
JugglerGroup::
	db  6, DEX_MARILL, DEX_GYOPIN, 0

BlackbeltGroup::
	db  6, DEX_CLEFFA, DEX_GYOPIN, 0
...
if DEF(_GOLD)
	...
	db  9, DEX_SLOWKING, ITEM_NONE, MOVE_DISABLE, MOVE_CONFUSION, MOVE_NONE, MOVE_NONE
	db -1 ; end
endc
if DEF(_SILVER)
	; SCHOOLBOY_TETSUYA
	db "てつや@", TRAINERTYPE_ITEM
	db  8, DEX_SLOWKING, ITEM_NONE
	db -1 ; end
endc
...
if DEF(_GOLD)
	...
	db 10, DEX_MAGBY, ITEM_NONE, MOVE_SCRATCH, MOVE_SMOG, MOVE_NONE, MOVE_NONE
	db -1 ; end
endc
if DEF(_SILVER)
	; FIREBREATHER_AKITO
	db "あきと@", TRAINERTYPE_ITEM
	db  8, DEX_MAGBY, ITEM_NONE
	db -1 ; end
endc
