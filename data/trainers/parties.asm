...
; Leftover Engineer data from Red/Blue
	...
	db 18, MON_MAGNEMITE, MON_MAGNEMITE, MON_RAREMAGNEMITE, 0
...
; Leftover Scientist data from Red/Blue
	...
	db 28, MON_MAGNEMITE, MON_VOLTORB, MON_RAREMAGNEMITE, 0
	db 29, MON_ELECTRODE, MON_WEEZING, 0
	db 33, MON_ELECTRODE, 0
	db 26, MON_RAREMAGNEMITE, MON_KOFFING, MON_WEEZING, MON_MAGNEMITE, 0
	db 25, MON_VOLTORB, MON_KOFFING, MON_RAREMAGNEMITE, MON_MAGNEMITE, MON_KOFFING, 0
	db 29, MON_ELECTRODE, MON_MUK, 0
	db 29, MON_GRIMER, MON_ELECTRODE, 0
	db 28, MON_VOLTORB, MON_KOFFING, MON_RAREMAGNEMITE, 0
	db 29, MON_MAGNEMITE, MON_KOFFING, 0
	db 33, MON_MAGNEMITE, MON_RAREMAGNEMITE, MON_VOLTORB, 0
...
; Leftover Channeler data from Red/Blue
	...
	db 24, MON_GHOS, 0
	db 24, MON_GHOS, 0
	db 34, MON_GHOS, MON_HAUNTER, 0
	db 38, MON_HAUNTER, 0
	db 33, MON_GHOS, MON_GHOS, MON_HAUNTER, 0
