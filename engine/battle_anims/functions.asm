...
; Zeroes Y offset instead of actually despawning the object like in the final game.
.done
	call BattleAnim_IncAnonJumptableIndex
	ld hl, BATTLEANIMSTRUCT_YOFFSET
	add hl, bc
...
; Split into its own function in final game so that it could be reused by Rock Smash.
...
.three
	...
	ldh [hLYOverrideStart], a
	ldh [hLYOverrideEnd], a
; This is index 4 in the final game's anon jump table. The proto's table lacks this entry.
	call DeinitBattleAnimation
	ret
...
; Obj moves down and disappears at y coord $38
...
; Object is thrown at target. After $20 frames it stops and waits another $20 frames then disappears.
...
; Creates the Confuse Ray object and moves it across the screen until x coord equals $80.
...
; Split into its own function in the final game.
