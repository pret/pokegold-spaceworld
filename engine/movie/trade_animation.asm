...
; earlier and unreferenced versions of the Trade and Battle areas.

UnreferencedMapPokecenterTrade:
	map_attributes_old UnreferencedMapPokecenterTrade, OLD_CITY_POKECENTER_TRADE, OFFICE, 0	; OFFICE occupies the id that CLUB used to be in.

	UnreferencedMapPokecenterTrade_ScriptLoader:
	ret

	UnreferencedMapPokecenterTrade_TextPointers:
	dw UnreferencedMapPokecenterTradeText1

	UnreferencedMapPokecenterTradeText1:
	text "！"
	done 

	UnreferencedMapPokecenterTrade_MapEvents:
	UnreferencedMapPokecenterTrade_Blocks:
	INCBIN "maps/OldCityPokecenterTrade.blk"

UnreferencedMapPokecenterBattle:
	map_attributes_old UnreferencedMapPokecenterBattle, OLD_CITY_POKECENTER_BATTLE, OFFICE, 0	; OFFICE occupies the id that CLUB used to be in.

	UnreferencedMapPokecenterBattle_ScriptLoader:
	jp UnreferencedMapPokecenterTrade_ScriptLoader

	UnreferencedMapPokecenterBattle_TextPointers:
	dw UnreferencedMapPokecenterBattleText1

	UnreferencedMapPokecenterBattleText1:
	text "！"
	done 

	UnreferencedMapPokecenterBattle_MapEvents:
	UnreferencedMapPokecenterBattle_Blocks:
