...
PoliwagIcon:: INCBIN "gfx/icons/nyoromo.2bpp"
JigglypuffIcon:: INCBIN "gfx/icons/purin.2bpp"
DiglettIcon:: INCBIN "gfx/icons/digda.2bpp"
PikachuIcon:: INCBIN "gfx/icons/pikachu.2bpp"
StaryuIcon:: INCBIN "gfx/icons/hitodeman.2bpp"
MagikarpIcon:: INCBIN "gfx/icons/koiking.2bpp"
PidgeyIcon:: INCBIN "gfx/icons/poppo.2bpp"
RhydonIcon:: INCBIN "gfx/icons/sidon.2bpp"
ClefairyIcon:: INCBIN "gfx/icons/pippi.2bpp"
OddishIcon:: INCBIN "gfx/icons/nazonokusa.2bpp"
MushiIcon:: INCBIN "gfx/icons/mushi.2bpp"
GengarIcon:: INCBIN "gfx/icons/gangar.2bpp"
LaprasIcon:: INCBIN "gfx/icons/laplace.2bpp"
MrMimeIcon:: INCBIN "gfx/icons/barrierd.2bpp"
LokonIcon:: INCBIN "gfx/icons/lokon.2bpp"
TaurosIcon:: INCBIN "gfx/icons/kentauros.2bpp"
ShellderIcon:: INCBIN "gfx/icons/shellder.2bpp"
DittoIcon:: INCBIN "gfx/icons/metamon.2bpp"
OnixIcon:: INCBIN "gfx/icons/iwark.2bpp"
VoltorbIcon:: INCBIN "gfx/icons/biriridama.2bpp"
SquirtleIcon:: INCBIN "gfx/icons/zenigame.2bpp"
BulbasaurIcon:: INCBIN "gfx/icons/fushigidane.2bpp"
CharmanderIcon:: INCBIN "gfx/icons/hitokage.2bpp"
WeedleIcon:: INCBIN "gfx/icons/beedle.2bpp"
AnnonIcon:: INCBIN "gfx/icons/annon.2bpp"
GeodudeIcon:: INCBIN "gfx/icons/isitsubute.2bpp"
MachopIcon:: INCBIN "gfx/icons/wanriky.2bpp"
EggIcon:: INCBIN "gfx/icons/egg.2bpp"
TentacoolIcon:: INCBIN "gfx/icons/menokurage.2bpp"
ButterfreeIcon:: INCBIN "gfx/icons/butterfree.2bpp"
ZubatIcon:: INCBIN "gfx/icons/zubat.2bpp"
SnorlaxIcon:: INCBIN "gfx/icons/kabigon.2bpp"
...
RhydonSpriteGFX:: INCBIN "gfx/sprites/sidon.2bpp"
ClefairySpriteGFX:: INCBIN "gfx/sprites/pippi.2bpp"
PidgeySpriteGFX:: INCBIN "gfx/sprites/poppo.2bpp"
CharizardSpriteGFX:: INCBIN "gfx/sprites/lizardon.2bpp"
SnorlaxSpriteGFX:: INCBIN "gfx/sprites/kabigon.2bpp"
SeelSpriteGFX:: INCBIN "gfx/sprites/pawou.2bpp"
PoliwrathSpriteGFX:: INCBIN "gfx/sprites/nyorobon.2bpp"
LaprasSpriteGFX:: INCBIN "gfx/sprites/laplace.2bpp"
