...
; initializes necessary data to load a sprite and runs UncompressSpriteDataLoop
	...
	ld a, $03                 ; bit offsets in output byte: 33 22 11 00
...
.readNextInput
	...
	jr .readNextInput
.readRLEncodedZeros
	ld c, $00                  ; number of zeroes it length encoded, the number
...
.storeDecodeTablesPointers
	...
	ld e, $00                         ; last decoded nybble, initialized to 0
.decodeNextByteLoop
	ld a, [wSpriteOutputPtr]
	ld l, a
	ld a, [wSpriteOutputPtr + 1]
