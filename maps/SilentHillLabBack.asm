...
SilentHillLabBackScriptPointers::
	def_script_pointers
	script_pointer Default,               SCENE_SILENT_HILL_LAB_BACK_DEFAULT
	script_pointer OakInstruction,        SCENE_SILENT_HILL_LAB_BACK_OAK_INSTRUCTION
	script_pointer ChooseStarter,         SCENE_SILENT_HILL_LAB_BACK_CHOOSE_STARTER
	script_pointer RivalChoosingStarter,  SCENE_SILENT_HILL_LAB_BACK_RIVAL_CHOOSING_STARTER
	script_pointer RivalChoosingStarter2, SCENE_SILENT_HILL_LAB_BACK_RIVAL_CHOOSING_STARTER2
	script_pointer RivalChoosingStarter3, SCENE_SILENT_HILL_LAB_BACK_RIVAL_CHOOSING_STARTER3
	script_pointer CutsceneOver,          SCENE_SILENT_HILL_LAB_BACK_CUTSCENE_OVER
