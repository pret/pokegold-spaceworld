...
SilentHillLabFrontScriptPointers::
	def_script_pointers
	script_pointer SilentHillLabFrontScript1, SilentHillLabFrontNPCIDs1, SCRIPT_SILENT_HILL_LAB_FRONT_DEFAULT
	script_pointer SilentHillLabFrontScript2, SilentHillLabFrontNPCIDs2, SCRIPT_SILENT_HILL_LAB_FRONT_START_BLUE_CUTSCENE
	script_pointer SilentHillLabFrontScript3, SilentHillLabFrontNPCIDs2, SCRIPT_SILENT_HILL_LAB_FRONT_BLUE_CUTSCENE
	script_pointer SilentHillLabFrontScript4, SilentHillLabFrontNPCIDs2, SCRIPT_SILENT_HILL_LAB_FRONT_BLUE_CUTSCENE_2
	script_pointer SilentHillLabFrontConversation1, SilentHillLabFrontNPCIDs2, SCRIPT_SILENT_HILL_LAB_FRONT_BLUE_CUTSCENE_CONVERSATION
	script_pointer SilentHillLabFrontScript6, SilentHillLabFrontNPCIDs3, SCRIPT_SILENT_HILL_LAB_FRONT_BLUE_CUTSCENE_END
	script_pointer SilentHillLabFrontScript7, SilentHillLabFrontNPCIDs4, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_ENTER_BACK
	script_pointer SilentHillLabFrontScript8, SilentHillLabFrontNPCIDs5, SCRIPT_SILENT_HILL_LAB_FRONT_ENTER_BACK
	script_pointer SilentHillLabFrontScript9, SilentHillLabFrontNPCIDs5, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_CUTSCENE
	script_pointer SilentHillLabFrontScript10, SilentHillLabFrontNPCIDs5, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_CUTSCENE_2
	script_pointer SilentHillLabFrontScript11, SilentHillLabFrontNPCIDs5, SCRIPT_SILENT_HILL_LAB_FRONT_GET_POKEDEX
	script_pointer SilentHillLabFrontScript12, SilentHillLabFrontNPCIDs6, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_WAIT_FOR_BATTLE
	script_pointer SilentHillLabFrontScript13, SilentHillLabFrontNPCIDs6, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_START_BATTLE
	script_pointer SilentHillLabFrontScript14, SilentHillLabFrontNPCIDs6, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_BATTLE_END
	script_pointer SilentHillLabFrontScript15, SilentHillLabFrontNPCIDs7, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_LEFT
	script_pointer SilentHillLabFrontScript16, SilentHillLabFrontNPCIDs7, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_LEFT_END
	script_pointer SilentHillLabFrontScript17, SilentHillLabFrontNPCIDs7, SCRIPT_SILENT_HILL_LAB_FRONT_GET_POKEBALLS
	script_pointer SilentHillLabFrontScript18, SilentHillLabFrontNPCIDs7, SCRIPT_SILENT_HILL_LAB_FRONT_GOT_POKEBALLS
	script_pointer SilentHillLabFrontScript19, SilentHillLabFrontNPCIDs9, SCRIPT_SILENT_HILL_LAB_FRONT_FINISHED
...
SilentHillLabFrontScript2:
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_BLUE_CUTSCENE
...
SilentHillLabFrontScript3:
	...
	ld hl, wOverworldFlags
	set OVERWORLD_PAUSE_MAP_PROCESSES_F, [hl]
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_BLUE_CUTSCENE_2
	ld [wMapScriptNumber], a
	ld a, MAPSTATUS_EVENT_RUNNING
	call SetMapStatus
	ret
...
SilentHillLabFrontScript4:
	...
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_BLUE_CUTSCENE_CONVERSATION
	ld [wMapScriptNumber], a
	ret
...
SilentHillLabFrontScript5:
	...
	ld hl, wOverworldFlags
	set OVERWORLD_PAUSE_MAP_PROCESSES_F, [hl]
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_BLUE_CUTSCENE_END
	ld [wMapScriptNumber], a
	ld a, MAPSTATUS_EVENT_RUNNING
	call SetMapStatus
	ret
...
SilentHillLabFrontScript6:
	...
	ld hl, wOverworldFlags
	set OVERWORLD_PAUSE_MAP_PROCESSES_F, [hl]
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_ENTER_BACK
	ld [wMapScriptNumber], a
	ld a, MAPSTATUS_EVENT_RUNNING
	call SetMapStatus
	ret
...
SilentHillLabFrontScript7:
	...
	ld hl, wOverworldFlags
	set OVERWORLD_PAUSE_MAP_PROCESSES_F, [hl]
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_ENTER_BACK
	ld [wMapScriptNumber], a
	ld a, MAPSTATUS_EVENT_RUNNING
	call SetMapStatus
	ret
...
SilentHillLabFrontScript8:
	...
	ld hl, wOverworldFlags
	set OVERWORLD_PAUSE_MAP_PROCESSES_F, [hl]
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_CUTSCENE
	ld [wMapScriptNumber], a
	ld a, MAPSTATUS_EVENT_RUNNING
	call SetMapStatus
	ret
...
SilentHillLabFrontScript9:
	...
	ld hl, wOverworldFlags
	set OVERWORLD_PAUSE_MAP_PROCESSES_F, [hl]
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_CUTSCENE_2
	ld [wMapScriptNumber], a
	ld a, MAPSTATUS_EVENT_RUNNING
	call SetMapStatus
	ret
...
SilentHillLabFrontScript10:
	...
	ld hl, wOverworldFlags
	set OVERWORLD_PAUSE_MAP_PROCESSES_F, [hl]
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_GET_POKEDEX
	ld [wMapScriptNumber], a
	ld a, MAPSTATUS_EVENT_RUNNING
	call SetMapStatus
	ret
...
SilentHillLabFrontScript11:
	...
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_WAIT_FOR_BATTLE
	ld [wMapScriptNumber], a
...
.jump
	...
	ld hl, wOverworldFlags
	set OVERWORLD_PAUSE_MAP_PROCESSES_F, [hl]
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_START_BATTLE
	ld [wMapScriptNumber], a
	ld a, MAPSTATUS_EVENT_RUNNING
	call SetMapStatus
	call xor_a
...
SilentHillLabFrontScript13:
	...
	ld [wMapStatus], a
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_BATTLE_END
	ld [wMapScriptNumber], a
	call InitObjectMasks
	ret
...
.skip
	...
	ld hl, wOverworldFlags
	set OVERWORLD_PAUSE_MAP_PROCESSES_F, [hl]
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_LEFT
	ld [wMapScriptNumber], a
	ld a, MAPSTATUS_EVENT_RUNNING
	call SetMapStatus
	ret
...
SilentHillLabFrontScript15:
	call UnfreezeEverything
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_LEFT_END
	ld [wMapScriptNumber], a
	call InitObjectMasks
	ret
...
.jump
	...
	ld hl, wOverworldFlags
	set OVERWORLD_PAUSE_MAP_PROCESSES_F, [hl]
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_GET_POKEBALLS
	ld [wMapScriptNumber], a
	ld a, MAPSTATUS_EVENT_RUNNING
	call SetMapStatus
	call xor_a
...
SilentHillLabFrontScript17:
	...
	call ReceiveItem
	call UnfreezeEverything
	ld a, SCRIPT_SILENT_HILL_LAB_FRONT_GOT_POKEBALLS
	ld [wMapScriptNumber], a
	ret
...
SilentHillLabFrontText4:
	...
	cp SCRIPT_SILENT_HILL_LAB_FRONT_RIVAL_LEFT
...
SilentHillLabFrontText7:
	ld a, [wMapScriptNumber]
	cp SCRIPT_SILENT_HILL_LAB_FRONT_FINISHED
	jr z, .jump
